...
homepage: https://wiki.operator.onl/hardware/en/lichee/RV_Nano/1_intro.html
...
Most I2C/SPI pins are shared with WiFi on Operator Online boards. You must configure pinmux before use.
